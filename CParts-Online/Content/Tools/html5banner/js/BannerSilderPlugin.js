/**
Jquery BannerSilder Html5 3D 轮播插件
Use: jQuery.BannerSliderPlugin("#BannerSlider",5);
Html:
     <div class="pics_wrap">
        <div id="BannerSlider">
...
**/
jQuery.BannerSliderPlugin = function (obj, timer) {
    var scripts = document.getElementsByTagName("script");
    var jsFolder = "";
    for (var i = 0; i < scripts.length; i++) {
        if (scripts[i].src && scripts[i].src.match(/BannerSilderPlugin\.js/i))
            jsFolder = scripts[i].src.substr(0, scripts[i].src.lastIndexOf("/") + 1);
    }  
    var win_width = '100%';//$(window).width();
    jQuery(""+obj+"").html5zoo({
        jsfolder: jsFolder,
        width: win_width,
        //height: 678,
        ...
        addmargin: true,
        randomplay: false,
        slideinterval: timer*1000,     // 控制时间
        enabletouchswipe: true,
        transitiononfirstslide: false,
        loop: 0,
        autoplay: true,
        navplayvideoimage: "../images/playvideo-64-64-0.png",
        navpreviewheight: 60,
        timerheight: 2,
        shownumbering: false,
        skin: "Frontpage",
        ...
        //slide右到左crossfade淡出threedhorizontal竖直转动slice百叶窗fade快速淡入淡出blocks加载blinds百叶窗2 shuffle碎块threed卷洞
        transition: "slide,threedhorizontal,slice,fade,blocks,blinds,threed"
