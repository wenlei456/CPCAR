...
(function( $ )
{
    ...
    $.extend(Wysiwyg, {
        ...
        TOOLBAR : {
            ...
            h1mozilla : { visible : true && ismozilla, className : 'h1', command : 'heading', arguments : ['h1'], tags : ['h1'] },
            h2mozilla : { visible : true && ismozilla, className : 'h2', command : 'heading', arguments : ['h2'], tags : ['h2'] },
            h3mozilla : { visible : true && ismozilla, className : 'h3', command : 'heading', arguments : ['h3'], tags : ['h3'] },

            h1 : { visible : true && !( ismozilla ), className : 'h1', command : 'formatBlock', arguments : ['Heading 1'], tags : ['h1'] },
            h2 : { visible : true && !( ismozilla ), className : 'h2', command : 'formatBlock', arguments : ['Heading 2'], tags : ['h2'] },
            h3 : { visible : true && !( ismozilla ), className : 'h3', command : 'formatBlock', arguments : ['Heading 3'], tags : ['h3'] },
            ...
            separator08 : { separator : true && !( ismsie ) },

            increaseFontSize : { visible : true && !( ismsie ), tags : ['big'] },
            decreaseFontSize : { visible : true && !( ismsie ), tags : ['small'] },
    ...
    $.extend(Wysiwyg.prototype,
    {
        ...
        initFrame : function()
        {
            ...
            {
                if ( ismsie && self.options.brIE && event.keyCode == 13 )
                {
