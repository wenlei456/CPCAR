...
namespace WxPayAPI
{
    ...
    public class JsApiPay
    {
	    ...
	    */
         ...
         * @失败时抛异常WxPayException
         */
        public WxPayData GetUnifiedOrderResult(string body, string oid, int payPrice, string opid)
        {
            log.Info("调用统一下单，获得下单结果");
            //统一下单
            WxPayData data = new WxPayData();
            data.SetValue("body", body);
            data.SetValue("attach", oid);
            data.SetValue("out_trade_no", oid);
            data.SetValue("total_fee", payPrice);
            ...
            {
                log.Info("GetUnifiedOrderResult====>UnifiedOrder response error!");
        ...
        */
        ...
        {
            log.Info("GetJsApiParameters------>JsApiPay::GetJsApiParam is processing...");
	    ...
	    */
        public string GetEditAddressParameters()
	    {
            ...
            try
            {
                ...
                signData.SetValue("appid",WxPayConfig._APPID);
                ...
                afterData.SetValue("appId",WxPayConfig._APPID);
                ...
                log.Info( "Get EditAddressParam : " + parameter);
            }
            catch (Exception ex)
            {
